...
const TRANSLATION_MATRIX: TranslationEntry[] = [
  {
    ...
    meaning:
      "The foundation is unstable. Energy is processing too fast at the source and not reaching the destination. The center isn't holding.",
    emoji: '⚡',
    validation:
      'I can see things are running hot right now. Let me hold space while the temperature comes down.',
  },
  {
    ...
    meaning:
      'Boundaries are up. Love/moisture cannot get in easily. Needs heat and time to penetrate. A defensive state.',
    emoji: '🛡️',
  ...
  },
  {
    ...
    meaning:
      'Absorbing everything too quickly. Damaged cuticle. Needs protein (structure) to hold shape.',
    emoji: '🌊',
  ...
  },
  {
    ...
    meaning:
      'A structure based on dependency and central authority. Beautiful, traditional, but the neutral wire is gone.',
    emoji: '⭐',
  ...
  },
  {
    ...
    meaning:
      'A network of equals. Decentralized. Everyone stands on their own power. Peer-to-peer connection.',
    emoji: '🔺',
    validation:
      "We're building something stronger. A mesh that can't be broken by any single point of failure.",
  },
  {
    ...
    meaning:
      'A necessary period where things feel "off" or disconnected. Not a failure - a transformation.',
    emoji: '🌙',
  ...
  },
  {
    ...
    meaning:
      'Repairing the disulfide bonds. Creating permanent links that give strength without brittleness.',
    emoji: '🔗',
    validation:
      "I'm not trying to cut us apart. I'm trying to repair the bonds so we're strong enough to stand together.",
  },
  {
  ...
  },
  {
    ...
    meaning:
      'The important message is getting lost in static. Need to smooth out the interference.',
    emoji: '📡',
