...
const SECTIONS: Section[] = [
    ...
    content: (
      <>
        ...
        <div style={styles.subsection}>
          ...
          <p>
            Your brain is 75% water. Dehydration causes brain fog, anxiety, and reduced
            problem-solving. Fill a water bottle. Drink it. That's it.
          </p>
        </div>
        ...
        <div style={styles.subsection}>
          ...
          <p>
            Your prefrontal cortex runs on glucose. No food = no executive function. Eat literally
            anything. A handful of crackers counts.
          </p>
        ...
        <div style={styles.subsection}>
          ...
          <p>
            Not exercise. Just movement. Stand up, shake your hands for 30 seconds, shake your whole
            body for 30 more seconds. Done.
          </p>
          <p style={{ marginTop: '0.5rem', fontSize: '0.9rem', opacity: 0.8 }}>
            This completes the stress cycle. Animals do this after escaping predators. You need to
            too.
          </p>
        </div>
          ...
          <table style={styles.table}>
            <tbody>
              <tr>
                ...
                <td style={styles.td}>Name 5 things you can SEE</td>
              </tr>
              <tr>
                <td style={styles.td}>
                  <strong>4</strong>
                </td>
                <td style={styles.td}>Name 4 things you can TOUCH</td>
              </tr>
              <tr>
                <td style={styles.td}>
                  <strong>3</strong>
                </td>
                <td style={styles.td}>Name 3 things you can HEAR</td>
              </tr>
              <tr>
                <td style={styles.td}>
                  <strong>2</strong>
                </td>
                <td style={styles.td}>Name 2 things you can SMELL</td>
              </tr>
              <tr>
                <td style={styles.td}>
                  <strong>1</strong>
                </td>
                <td style={styles.td}>Name 1 thing you can TASTE</td>
              </tr>
            </tbody>
          </table>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          You cannot solve higher-level problems until lower-level needs are met. Handle these in
          order:
        </p>
        ...
        <div style={styles.subsection}>
          ...
          <div style={styles.checklistItem}>
            ...
            <span>Water (drink more than you think)</span>
          </div>
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>Food (even bad food is better than none)</span>
          </div>
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>Sleep (non-negotiable)</span>
          </div>
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>Shelter (safe place to sleep tonight)</span>
          </div>
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
        ...
        <div style={styles.subsection}>
          ...
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>Know where next meal is coming from</span>
          </div>
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>Can pay rent this month</span>
          </div>
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>Have healthcare access</span>
          </div>
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>Have one emergency contact</span>
          </div>
        </div>
        ...
        <div style={styles.subsection}>
          ...
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>Sleeping 6+ hours most nights</span>
          </div>
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>Can regulate emotions enough to function</span>
          </div>
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>Can get through a day without shutdown</span>
          </div>
        </div>
    ...
    content: (
      <>
        ...
        <div style={styles.subsection}>
          ...
          <p>
            It's not laziness. It's a physiological state of HPA axis dysfunction. Your cortisol
            system is broken. Recovery takes months to years.
          </p>
        </div>
        ...
        <div style={styles.subsection}>
          ...
          <p>
            Many people don't get diagnosed until adulthood. Seeking diagnosis is not "looking for
            an excuse" — it's seeking accurate information about your neurology.
          </p>
        </div>
        ...
        <div style={styles.subsection}>
          ...
          <p>
            PTSD causes measurable changes in brain structure. Your reactions are not
            "overreactions" — they're appropriate responses from a brain shaped by survival.
          </p>
        </div>
        ...
        <div style={styles.subsection}>
          ...
          <p>
            If you've spent your life pretending to be "normal," you've been running a constant
            energy-draining background process. No wonder you're tired.
          </p>
        </div>
        ...
        <div style={styles.subsection}>
          ...
          <p>
            You can grieve the marriage you thought you'd have, the parent you needed, the career
            that didn't work out, the years spent masking, the diagnosis that came too late.
          </p>
        </div>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          After 3 days of poor sleep, you're cognitively impaired equivalent to being legally drunk.
          You cannot think your way out of a problem you're too tired to think about.
        </p>
        ...
        <div style={styles.subsection}>
          ...
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>Same wake time every day (even weekends)</span>
          </div>
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>No screens 1 hour before bed</span>
          </div>
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>Room as dark as possible</span>
          </div>
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>Room cool (65-68°F)</span>
          </div>
          <div style={styles.checklistItem}>
            <div style={styles.checkbox}></div>
            <span>No caffeine after 2pm</span>
          </div>
        </div>
        ...
        <div style={styles.subsection}>
          ...
          <p>
            <strong>4-7-8 breathing:</strong> Inhale 4 seconds, hold 7, exhale 8
          </p>
          <p>
            <strong>Get up after 20 minutes.</strong> Do something boring. Try again.
          </p>
          <p>
            <strong>Consider magnesium glycinate</strong> supplement (helps many people)
          </p>
        </div>
      </>
    ),
          ...
          <table style={styles.table}>
            <tbody>
              <tr>
                ...
                <td style={styles.td}>
                  Splash face, triggers dive reflex, lowers heart rate in 30 sec
                </td>
              </tr>
              <tr>
                <td style={styles.td}>
                ...
                <td style={styles.td}>Inhale 4s, hold 4s, exhale 4s, hold 4s — repeat 4x</td>
              </tr>
              <tr>
                <td style={styles.td}>
                  <strong>Bilateral Tapping</strong>
                </td>
                <td style={styles.td}>Tap alternating knees, mimics EMDR</td>
              </tr>
              <tr>
                <td style={styles.td}>
                  <strong>Humming</strong>
                </td>
                <td style={styles.td}>Vibrates vagus nerve, activates calm</td>
              </tr>
              <tr>
                <td style={styles.td}>
                  <strong>Brown Noise</strong>
                </td>
                <td style={styles.td}>YouTube "brown noise" — many NDs find this essential</td>
              </tr>
            </tbody>
          </table>
        </div>
    ...
    content: (
      <>
        <div style={styles.subsection}>
          ...
          <ul style={styles.list}>
            <li style={styles.listItem}>
              • <strong>Medicaid:</strong> Apply if income under ~$20k/year
            </li>
            <li style={styles.listItem}>
              • <strong>ACA Marketplace:</strong> Subsidies can make premiums $0-50/month
            </li>
            <li style={styles.listItem}>
              • <strong>Community Health Centers:</strong> findahealthcenter.hrsa.gov
            </li>
            <li style={styles.listItem}>
              • <strong>GoodRx:</strong> Cut prescription costs 80%+
            </li>
          </ul>
        </div>
        ...
        <div style={styles.subsection}>
          ...
          <ul style={styles.list}>
            <li style={styles.listItem}>
              • <strong>Open Path Collective:</strong> Therapy $30-80/session
            </li>
            <li style={styles.listItem}>
              • <strong>Community mental health:</strong> Sliding scale
            </li>
            <li style={styles.listItem}>
              • <strong>NAMI:</strong> Free support groups
            </li>
            <li style={styles.listItem}>
              • <strong>University clinics:</strong> Low-cost training clinics
            </li>
          </ul>
        </div>
        ...
        <div style={styles.subsection}>
          ...
          <ul style={styles.list}>
            <li style={styles.listItem}>
              • <strong>The Four Walls:</strong> Pay in order — Food, Utilities, Shelter, Transport
            </li>
            <li style={styles.listItem}>
              • <strong>211:</strong> Connects to local assistance
            </li>
            <li style={styles.listItem}>
              • <strong>Call creditors BEFORE missing payments</strong> — most have hardship
              programs
            </li>
            <li style={styles.listItem}>
              • <strong>SNAP/Food Stamps:</strong> Apply online, often same-day approval
            </li>
          </ul>
        </div>
        ...
        <div style={styles.subsection}>
          ...
          <ul style={styles.list}>
            <li style={styles.listItem}>
              • <strong>lawhelp.org:</strong> Find free legal aid
            </li>
            <li style={styles.listItem}>
              • <strong>Bar association pro bono programs</strong>
            </li>
            <li style={styles.listItem}>
              • <strong>Law school clinics:</strong> Free help from supervised students
            </li>
            <li style={styles.listItem}>
      ...
      <>
        ...
        <table style={styles.table}>
          ...
          <tbody>
            <tr>
              <td style={styles.td}>
                <strong>Month 1-3</strong>
              </td>
              <td style={styles.td}>
                Survival mode. Basic needs. One routine. One support person.
              </td>
            </tr>
            <tr>
              <td style={styles.td}>
        ...
        <div style={styles.highlight}>
          You will have terrible days at month 10. You will have great days at month 2. The overall
    ...
    content: (
      <>
        <div style={styles.subsection}>
          ...
          <p>
            You're not failing at these systems — the systems are failing. The solution isn't to try
            harder at the old game; it's to build new structures.
          </p>
        </div>
        ...
        <div style={styles.subsection}>
          ...
          <p>
            You cannot think your way out of dysregulation. You have to regulate first, then think.
            This is why all the good advice hasn't worked.
          </p>
        </div>
        ...
        <div style={styles.subsection}>
          ...
          <p>
            What feels like falling apart is often transformation. The caterpillar doesn't "improve"
            — it dissolves completely and reforms.
          </p>
        </div>
        ...
        <div style={styles.subsection}>
          ...
          <p>
            The survival skills you're building are gifts you'll eventually give to others. Your
    ...
    <div style={styles.container}>
      ...
      <footer style={styles.footer}>
        ...
        <p style={{ marginTop: '2rem', fontSize: '0.9rem' }}>
          ...
          <br />
          You are a node in a network that needs you.
          <br />
          Stay connected.
        </p>
      </footer>
