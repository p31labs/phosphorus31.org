        ...
        files: [
          {
            ...
            path: 'project.godot',
            type: 'Project',
            content: getTemplateContent('project.godot'),
            isModified: false,
          },
          {
            name: 'main.tscn',
            ...
            type: 'Scene',
            content: getTemplateContent('scenes/main.tscn'),
            isModified: false,
          },
          {
            name: 'player.gd',
            ...
            type: 'GDScript',
            content: getTemplateContent('scripts/player.gd'),
            isModified: false,
          },
          {
            name: 'quantum_field.gd',
            path: 'scripts/quantum_field.gd',
            type: 'GDScript',
            content: getTemplateContent('scripts/quantum_field.gd'),
            isModified: false,
          },
        ],
        scenes: [
...
func _ready():
  ...
  const saveFile = useCallback(() => {
    ...
    const updatedFiles = project.files.map((file) =>
      file.path === selectedFile ? { ...file, content: fileContent, isModified: false } : file
    );
      ...
      >
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '18px', marginBottom: '10px' }}>
            Initializing Godot WASM Studio
          </div>
                ...
                {project.scenes.map((scene) => (
                  <div
                    ...
                    style={{
                      ...
                      margin: '2px 8px',
                      backgroundColor:
                        project.currentScene === scene.path ? '#22c55e20' : 'transparent',
                    }}
        ...
        <div style={{ flex: 1, overflow: 'hidden' }}>
            ...
            <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                  ...
                  {selectedFile && (
                    ...
                    >
                      {GODOT_FILE_TYPES[
                        ...
                        ) as keyof typeof GODOT_FILE_TYPES
                      ] || 'Unknown'}
                    </span>
                  )}
                </div>
              ...
              <textarea
                ...
                placeholder={
                  selectedFile
                    ? undefined
                    : 'Select a Godot script or scene file to start editing...'
                }
                style={{
                  flex: 1,
                  padding: '20px',
          ...
          {activeTab === 'scene' && (
            <div style={{ height: '100%', padding: '20px', overflowY: 'auto' }}>
              ...
              project.scenes.find((s) => s.path === project.currentScene) ? (
                <SceneGraph
            ...
            <div style={{ height: '100%', padding: '20px', overflowY: 'auto' }}>
              ...
              >
                ...
                >
                  ...
                  <br />
                  • Includes quantum coherence mechanics
                  <br />• WebAssembly performance optimizations
                </div>
              </div>
            </div>
          )}
...
function SceneGraph({ scene, onNodeSelect }: { scene: any; onNodeSelect: (node: any) => void }) {
