    ...
    >
      ...
      >
        ...
        <span
          style={{
            color:
              coherencePercent > 80 ? '#4ade80' : coherencePercent > 50 ? '#fbbf24' : '#ef4444',
            fontWeight: 'bold',
          }}
        >
...
export default function BreathEngine() {
  ...
  return (
    ...
    >
        ...
        {PATTERNS.map((pattern) => (
          <button
            ...
            style={{
              padding: '1rem',
              background:
                selectedPattern.id === pattern.id ? pattern.color : GOD_CONFIG.theme.bg.secondary,
              border:
          ...
          >
            <div style={{ fontWeight: 'bold', fontSize: '0.85rem', lineHeight: 1.3 }}>
              {pattern.name}
            </div>
            <div
              style={{
      ...
      <SacredGeometry phase={phase} progress={phaseProgress} color={selectedPattern.color} />
      ...
      <div style={{ textAlign: 'center', marginTop: '1rem' }}>
        ...
        <div style={{ fontSize: '0.9rem', opacity: 0.7 }}>{PHASE_INSTRUCTIONS[phase]}</div>
      </div>
      ...
      {/* Coherence Meter */}
      {(isRunning || cycleCount > 0) && <CoherenceMeter value={coherence} />}
      ...
      >
        ...
        <ul style={{ margin: '0.5rem 0', paddingLeft: '1.5rem' }}>
          <li>
            <strong>Inhale (Driver)</strong>: Perturbation. Gathering energy. Sympathetic
            activation.
          </li>
          <li>
            <strong>Hold (Clock)</strong>: Stillness. The reference frequency. CO₂ tolerance.
          </li>
          <li>
            <strong>Exhale (Tension)</strong>: Release. Resolution. Parasympathetic dominance.
          </li>
        </ul>
