...
const ACTIVITIES: Activity[] = [
  {
    ...
    emoji: '🧱',
    recovery: 1.0,
    description: 'Push against a wall with full force for 20s',
  },
  {
    id: 'weighted_blanket',
    ...
    emoji: '🛌',
    recovery: 1.5,
    description: '15 mins under pressure',
  },
  {
    id: 'walking',
    name: 'Walking',
    emoji: '🚶',
    recovery: 2.0,
    description: '10 min brisk walk outside',
  },
  {
    id: 'plank',
    name: 'Plank',
    emoji: '💪',
    recovery: 1.5,
    description: 'Hold as long as possible',
  },
  {
    id: 'jumping_jacks',
    name: 'Jumping Jacks',
    emoji: '🤸',
    recovery: 1.0,
    description: '20 reps to reset state',
  },
];
