  ...
  return (
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        {isActive && (
          <span style={{ fontFamily: 'monospace', color: '#10B981' }}>{Math.ceil(timeLeft)}s</span>
        )}
      </div>

      <p style={{ fontSize: '13px', color: '#9CA3AF', margin: 0 }}>
        Follow the lime dot with your eyes. Do not move your head. This triggers the oculocardiac
        reflex to lower heart rate.
      </p>
