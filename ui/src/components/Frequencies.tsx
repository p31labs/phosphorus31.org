      ...
      <div className="frequencies-container">
        ...
        {groupedTracks.map(({ artist, tracks }) => (
          <section key={artist.name} className="frequencies-artist-section">
            <div className="frequencies-artist" data-artist-color={artist.color}>
              <div className="frequencies-artist-header">
                ...
                <div className="frequencies-artist-info">
                  <h2 className="frequencies-artist-name" data-artist-color={artist.color}>
                    {artist.name}
                  </h2>
                  ...
                  >
                    ...
                    <div className="frequencies-track-header">
                      ...
                      <div className="frequencies-track-info">
                        ...
                        {track.album && <p className="frequencies-track-album">{track.album}</p>}
                      </div>
                    </div>
                    <div className="frequencies-track-vibe" data-track-color={track.color}>
                      {track.vibe}
                    </div>
        ...
        <section className="frequencies-prescription-section">
          <h2 className="frequencies-prescription-title">💊 Quick Prescription</h2>
          ...
          <div className="frequencies-prescription-grid">
            {PRESCRIPTIONS.map((rx, index) => (
              <div key={index} className="frequencies-prescription-card">
                <div className="frequencies-prescription-state">{rx.state}</div>
        ...
        <footer className="frequencies-footer">
          ...
          <p className="frequencies-footer-wonky">🎵 weave wobble be a little wonky 🎵</p>
        </footer>
      </div>
    </>
  );
