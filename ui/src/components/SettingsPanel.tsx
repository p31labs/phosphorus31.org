...
export function SettingsPanel() {
  ...
  const getStatusIcon = () => {
    switch (ollamaStatus) {
      ...
      default:
        return <Server size={12} style={{ animation: 'spin 1s linear infinite' }} />;
    }
  };
    ...
    <div style={{ marginBottom: 16 }}>
      ...
      <button
        ...
        style={{
          ...
          gap: 8,
          padding: '10px 16px',
          backgroundColor: isOpen ? GOD_CONFIG.theme.bg.accent : GOD_CONFIG.theme.bg.secondary,
              ...
              {providers.map((p) => (
                <button
                  ...
                  style={{
                    padding: '10px 8px',
                    backgroundColor:
                      provider === p.id ? GOD_CONFIG.theme.bg.accent : GOD_CONFIG.theme.bg.tertiary,
                    border: `1px solid ${
                      provider === p.id
              ...
              >
                ...
                {ollamaStatus === 'online' && (
                  ...
                  >
                    ...
                    <span>
                      <strong>Privacy First:</strong> All processing happens locally. No data leaves
                      your machine.
                    </span>
                  </div>
                )}
              ...
              <>
                ...
                <div
                  style={{
                    marginTop: 8,
                    fontSize: 11,
                    color: apiKey ? GOD_CONFIG.voltage.low.color : GOD_CONFIG.theme.text.muted,
                  }}
                >
                  {apiKey
              ...
              {humanOSOptions.map(([key, os]) => (
                <button
                  ...
                  style={{
                    padding: '12px',
                    backgroundColor:
                      userHumanOS === key ? `${os.color}20` : GOD_CONFIG.theme.bg.tertiary,
                    border: `1px solid ${
                      userHumanOS === key ? os.color : GOD_CONFIG.theme.border.default
                    }`,
                    borderRadius: 8,
                    color: userHumanOS === key ? os.color : GOD_CONFIG.theme.text.muted,
                    fontSize: 12,
                    fontFamily: GOD_CONFIG.typography.fontFamily.display,
                    cursor: 'pointer',
                    textAlign: 'left',
