  ...
  return (
    ...
    >
      ...
      >
        <button
          ...
          style={{
            padding: '8px 16px',
            backgroundColor:
              activeCategory === null ? GOD_CONFIG.theme.text.accent : GOD_CONFIG.theme.bg.tertiary,
            border: 'none',
            borderRadius: 6,
          ...
          return (
            <button
              ...
              style={{
                padding: '8px 16px',
                backgroundColor:
                  activeCategory === cat.id ? cat.color : GOD_CONFIG.theme.bg.tertiary,
                border: 'none',
                borderRadius: 6,
                    ...
                    <p
                      ...
                      dangerouslySetInnerHTML={{
                        __html: paragraph
                          ...
                          .replace(
                            /`(.*?)`/g,
                            '<code style="background: #1e1e2e; padding: 2px 6px; border-radius: 4px; font-size: 12px;">$1</code>'
                          ),
                      }}
                    />
                  ))}
      ...
      >
        ...
        >
          That's the only question that matters. Everything else is infrastructure to make it
          possible.
        </p>
      </div>
    </div>
