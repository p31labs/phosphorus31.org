      ...
      {isConnected && deviceState && (
        <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div>
                ...
                <p className="text-cyan-400 font-mono">
                  0x{deviceState.nodeId.toString(16).padStart(2, '0')}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-zinc-900/50 rounded p-3 space-y-3">
            ...
            <div>
              <div className="flex items-center justify-between text-sm mb-1">
                <label htmlFor="phenix-voltage" className="text-zinc-400">
                  ⚡ Voltage
                </label>
                <span
                  className={
                    deviceState.voltage <= 3
                      ? 'text-green-400'
                      : deviceState.voltage <= 6
                        ? 'text-yellow-400'
                        : 'text-red-400'
                  }
                >
            ...
            <div>
              <div className="flex items-center justify-between text-sm mb-1">
                <label htmlFor="phenix-spoons" className="text-zinc-400">
                  🥄 Spoons
                </label>
                <span
                  className={
                    deviceState.spoons >= 8
                      ? 'text-green-400'
                      : deviceState.spoons >= 4
                        ? 'text-yellow-400'
                        : 'text-red-400'
                  }
                >
