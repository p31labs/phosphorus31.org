...
function TetrahedronMesh({
  ...
  useEffect(() => {
    ...
    edgesRef.current.geometry.setAttribute('position', new THREE.Float32BufferAttribute(edges, 3));
    edgesRef.current.geometry.setAttribute('color', new THREE.Float32BufferAttribute(colors, 3));
  ...
  return (
    <group ref={meshRef}>
      ...
      {/* Nodes */}
      <instancedMesh ref={nodesRef} args={[undefined, undefined, 4]} position={[0, 0, 0]}>
        ...
        <>
          ...
          <group ref={quantumStateRef}>
            <arrowHelper
              args={[
                ...
                1.3,
                quantumState.purity > 0.8
                  ? '#22c55e'
                  : quantumState.purity > 0.5
                    ? '#eab308'
                    : '#ef4444',
                0.08,
                0.04,
          ...
          {state.sicPOVMs.map((povm, index) => (
            <Sphere
              key={index}
              args={[0.03, 8, 8]}
              position={[3 + povm.vector.x * 1.5, povm.vector.y * 1.5, povm.vector.z * 1.5]}
            >
              <meshBasicMaterial color="#a78bfa" emissive="#a78bfa" emissiveIntensity={0.3} />
            </Sphere>
          ))}
        </>
      )}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8 }}>
        ...
        {enableSimulation && (
          <>
            ...
            >
              <h3
                style={{ margin: '0 0 16px 0', color: GOD_CONFIG.theme.text.primary, fontSize: 16 }}
              >
                🔬 SIC-POVM Measurement Simulation
              </h3>
              ...
              <div style={{ display: 'flex', gap: 16, marginBottom: 16, flexWrap: 'wrap' }}>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setQuantumState((prev) => ({ ...prev, theta: parseFloat(e.target.value) }))
                    }
                    style={{ width: 120 }}
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setQuantumState((prev) => ({ ...prev, phi: parseFloat(e.target.value) }))
                    }
                    style={{ width: 120 }}
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setQuantumState((prev) => ({ ...prev, purity: parseFloat(e.target.value) }))
                    }
                    style={{ width: 120 }}
                  />
                </div>
