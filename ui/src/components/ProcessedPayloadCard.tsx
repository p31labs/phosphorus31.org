      ...
      >
        ...
        <div
          style={{
            ...
            padding: '6px 12px',
            backgroundColor:
              spoonsCost >= 4 ? `${GOD_CONFIG.voltage.high.color}15` : GOD_CONFIG.theme.bg.tertiary,
            border: `1px solid ${
              spoonsCost >= 4 ? GOD_CONFIG.voltage.high.color : GOD_CONFIG.theme.border.default
            }`,
            borderRadius: 8,
          }}
        >
          ...
          <span
            style={{
              ...
              fontFamily: GOD_CONFIG.typography.fontFamily.display,
              color:
                spoonsCost >= 4 ? GOD_CONFIG.voltage.high.color : GOD_CONFIG.theme.text.secondary,
            }}
          >
      ...
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
        <button
          ...
          style={{
            ...
            color: showTranslation ? GOD_CONFIG.theme.bg.primary : GOD_CONFIG.theme.text.secondary,
            border: `1px solid ${GOD_CONFIG.theme.border.default}`,
            borderRadius: 6,
            cursor: 'pointer',
            fontSize: 12,
