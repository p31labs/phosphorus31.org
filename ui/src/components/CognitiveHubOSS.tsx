...
export default function CognitiveHubOSS() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'processing' | 'deployment' | 'api'>(
    'overview'
  );
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        >
          Full-stack sovereign cognitive processing with Python backend, web interface, and local AI
          integration.
          <br />
              ...
              >
                ...
                <button
                  ...
                  style={{
                    marginTop: '0.5rem',
                    padding: '0.5rem 1rem',
                    backgroundColor: captureText.trim()
                      ? GOD_CONFIG.theme.text.accent
              ...
              >
                ...
                >
                  <div style={{ marginBottom: '0.5rem' }}>
                    git clone https://github.com/phenix-navigator/cognitive-hub-oss
                  </div>
      ...
      >
        ...
        >
          Complete sovereign cognitive processing stack with Python backend, web interface, and
          local AI. No external dependencies - runs entirely on your hardware.
        </p>
        <div
          style={{
            display: 'flex',
