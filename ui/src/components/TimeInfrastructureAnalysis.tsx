...
const RESEARCH_SECTIONS: ResearchSection[] = [
  {
    ...
    content: (
      <div>
        <p className="mb-4">
          The concentration of global time infrastructure creates what security researchers call the
          "Wye topology vulnerability"—a star configuration where targeting root time servers
          amplifies impact across all dependent systems.
        </p>
        ...
        <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
          ...
          <p className="text-sm text-gray-700 mb-2">
            Only 21 countries have more than a single NTP Pool provider. Cloudflare serves as the
            sole time source for many nations.
          </p>
  ...
  },
  {
    ...
    content: (
      <div>
        <p className="mb-4">
          Digital devices act as powerful artificial zeitgebers—environmental cues that synchronize
          biological clocks—through mechanisms the circadian system never evolved to handle.
        </p>
        ...
        <div className="p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
          ...
          <p className="text-sm text-indigo-700">
            Heart rate variability research identified 0.1 Hz (6 breaths/minute) as optimal
            physiological coherence state. This represents an internally-generated biological time
            reference independent of external clocks.
          </p>
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        <p className="mb-4">
          Production-ready Byzantine fault-tolerant protocols eliminate dependence on external time
          authorities, achieving cryptographic proof of server malfeasance.
        </p>
  ...
  },
  {
    ...
    content: (
      <div>
        <p className="mb-4">
          The solution follows electrical engineering principles: replace star (Wye) topology with
          mesh (Delta) topology for self-healing capability and distributed redundancy.
        </p>
  ...
  },
  {
    ...
    content: (
      <div>
        <p className="mb-4">
          Algorithmic timelines create divergent information-temporal realities through time
          collapse, accelerating attention dynamics, and erosion of shared attentional commons.
        </p>
        ...
        <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
          ...
          <p className="text-sm text-gray-700 mb-2">
            Not literal filter bubbles, but parallel information-temporal universes where different
            populations experience news events at different times, with different framing, through
            different algorithmic prioritization.
          </p>
          <div className="text-xs text-gray-600 italic">
            "Do we even have a common knowledge? Do we have a way in which we construe what's
            happening?"
          </div>
        </div>
      </div>
  ...
  },
  {
    ...
    content: (
      <div>
        <p className="mb-4">
          The most practical path for mesh temporal coordination uses ESP32-S3 microcontrollers with
          LoRa SX1262, targeting GPS-free localization and synchronization.
        </p>
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
            <h4 className="font-semibold text-purple-800 mb-2">
              🚀 Scaling to Quantum Applications
            </h4>
            <ul className="text-sm text-purple-700 space-y-1">
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        >
          Modern civilization depends on a fragile temporal infrastructure that mirrors the
          vulnerability of a Wye electrical topology. When the central time reference fails,
          desynchronization cascades across machines, bodies, and societies simultaneously.
        </p>
      </div>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
          {[
            { id: 'all', label: 'All Sections', count: RESEARCH_SECTIONS.length },
            {
              ...
              count: RESEARCH_SECTIONS.filter((s) => s.category === 'vulnerability').length,
            },
            {
              id: 'solution',
              label: 'Solutions',
              count: RESEARCH_SECTIONS.filter((s) => s.category === 'solution').length,
            },
            {
              id: 'analysis',
              label: 'Analysis',
              count: RESEARCH_SECTIONS.filter((s) => s.category === 'analysis').length,
            },
            {
              id: 'implementation',
              label: 'Implementation',
              count: RESEARCH_SECTIONS.filter((s) => s.category === 'implementation').length,
            },
          ].map(({ id, label, count }) => (
            <button
              key={id}
            ...
            >
              ...
              <span
                style={{
                  backgroundColor:
                    filterCategory === id ? 'rgba(255,255,255,0.2)' : GOD_CONFIG.theme.bg.secondary,
                  ...
                  >
                    <span
                      style={{
                        ...
                        borderRadius: '12px',
                        backgroundColor:
                          section.category === 'vulnerability'
                            ? '#fef2f2'
                            : section.category === 'solution'
                              ? '#f0fdf4'
