...
// TODO: Create these config files or remove references
...
// Stub values to unblock build
const SPACING = { xs: 4, sm: 8, md: 16, lg: 24, xl: 32 };
const GRID_GAP = 16;
const CARD_PADDING = 16;
const SECTION_GAP = 24;
const COLORS = { primary: '#2ecc71', secondary: '#60a5fa', text: '#ffffff' };
const FONT_SIZES = { sm: 12, md: 14, lg: 16, xl: 20 };
const CosmicTheme = { primary: '#2ecc71', secondary: '#60a5fa' };
    ...
    return (
      ...
      >
        ...
        <div style={CosmicTheme.ratioOverlay.style}>
          <span style={CosmicTheme.ratioOverlay.style}>{CosmicTheme.ratioOverlay.text}</span>
        </div>
        {/* Header */}
        <div
          style={{
        ...
        >
          <div style={{ fontSize: '12px', color: '#9CA3AF' }}>Energy needed:</div>
        ...
        >
          {GAMES.map((game) => (
            ...
            >
              ...
              <div style={{ fontSize: '12px', color: '#9CA3AF' }}>{game.description}</div>
            </button>
          ))}
        </div>
        ...
        >
          <p style={{ fontSize: '13px', color: '#C084FC', margin: 0 }}>
            💡 <strong>Tip:</strong> Start with low-energy games when you're tired. All games
            restore spoons - there's no wrong choice.
          </p>
        </div>
      </div>
    );
