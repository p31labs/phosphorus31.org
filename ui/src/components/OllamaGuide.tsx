...
export function OllamaGuide({ isOpen, onClose }: OllamaGuideProps) {
  const [activeSection, setActiveSection] = useState<
    'intro' | 'why' | 'how' | 'terms' | 'requirements'
  >('intro');
        ...
        >
          {[
            ...
            <button
              ...
              style={{
                padding: '8px 14px',
                backgroundColor: activeSection === id ? GOD_CONFIG.theme.bg.accent : 'transparent',
                border: `1px solid ${
                  activeSection === id
        ...
        >
          {activeSection === 'intro' && (
            <div>
              ...
              >
                Ollama is like the "App Store" or "User Interface" that lets you run powerful AI
                models (like ChatGPT) directly on your own computer, rather than over the internet.
              </p>
              <div
                style={{
                  padding: 16,
              ...
              >
                ...
                >
                  <strong style={{ color: GOD_CONFIG.voltage.low.color }}>With Ollama:</strong>{' '}
              ...
              >
                ...
                >
                  <strong>No subscription fees.</strong> No data collection. No internet required
                  after setup.
                </span>
              </div>
            </div>
                ...
                {[
                  {
                    ...
                    title: 'Privacy',
                    description:
                      'Your conversations never leave your computer. No one can see them.',
                  ...
                  },
                  {
                    ...
                    title: 'Cost',
                    description:
                      'Completely free to use. No monthly subscription, no usage limits.',
                    color: GOD_CONFIG.voltage.low.color,
                  },
                  {
                    icon: '🎨',
                    title: 'Customization',
                    description:
                      'Download different AI "personalities" for coding, writing, or analysis.',
                  ...
                  },
                  {
                    ...
                    title: 'Speed',
                    description:
                      'Responds quickly without needing Wi-Fi (if you have a decent computer).',
                    color: GOD_CONFIG.voltage.medium.color,
                  },
                ].map((item) => (
                  <div
          ...
          {activeSection === 'how' && (
            <div>
                ...
                {[
                  {
                    ...
                    icon: Download,
                    description:
                      'Go to ollama.com and download the app for Mac, Windows, or Linux.',
                    ...
                    action: (
                      <div style={{ marginTop: 8 }}>
                        ...
                        >
                          ...
                          <strong>Command Prompt</strong> (Windows) and type:
                        </p>
                        <code
                          style={{
                            display: 'block',
                        ...
                        >
                          Hit Enter. It will download the AI "brain" (this might take a few
                          minutes).
                        </p>
                      </div>
                    ),
                  },
                  {
                    ...
                    icon: MessageSquare,
                    description:
                      'Once it downloads, you can start typing questions right there in that window.',
              ...
              >
                ...
                >
                  <strong style={{ color: GOD_CONFIG.emotionalValence.calm.color }}>Note:</strong>{' '}
                  Ollama itself is a "command-line" tool (text on a black background). If you prefer
                  a pretty interface that looks like ChatGPT, many people pair Ollama with a
                  "frontend" like <strong>WebUI</strong> or <strong>AnythingLLM</strong>.
                </p>
              </div>
            </div>
          )}
                ...
                {[
                  {
                    term: 'Local LLM',
                    meaning:
                      'An AI "Large Language Model" running on your hardware, not the cloud.',
                  },
                  {
                    term: 'Parameters',
                    meaning:
                      "The size of the AI's brain (e.g., 8B, 70B). Higher numbers are smarter but require a more powerful computer.",
                  },
                  {
                    term: 'GPU',
