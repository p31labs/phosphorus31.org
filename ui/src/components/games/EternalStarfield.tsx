  ...
  return (
    <mesh ref={meshRef}>
      ...
      <mesh position={[-0.5, 0, 0]} scale={[2, 0.05, 0.05]}>
        <boxGeometry />
        <meshStandardMaterial color="#ffffff" transparent opacity={(1 - progress) * 0.5} />
      </mesh>
    </mesh>
  );
};
    ...
    <div className="w-full h-full bg-gradient-to-b from-purple-950 via-indigo-950 to-black relative">
      ...
      <div className="absolute top-4 left-4 z-10 text-white">
        ...
        <p className="text-sm text-purple-200 max-w-md">
          Their energy remains in the quantum mesh. Each star is a loved one— forever connected,
          forever present. Watch for shooting stars: those are moments when you feel their love
      ...
      <div className="absolute bottom-4 right-4 z-10 text-purple-300 text-sm max-w-sm text-right">
        <p className="italic">
          "Energy cannot be created or destroyed, only transformed. They are not gone—they are woven
          into the fabric of everything you are."
        </p>
