    ...
    >
      ...
      >
        <div style={{ textAlign: 'center' }}>
          <div style={{ color: '#F59E0B', fontSize: '32px', fontWeight: 700 }}>{moveCount}</div>
          <div style={{ color: '#9CA3AF', fontSize: '12px' }}>MOVES</div>
        </div>
        <div style={{ textAlign: 'center' }}>
          <div style={{ color: '#10B981', fontSize: '32px', fontWeight: 700 }}>{streak}</div>
      ...
      <button
        ...
        style={{
          ...
          fontSize: '32px',
          boxShadow: isPlaying ? '0 0 40px #EF444480' : '0 0 40px #10B98180',
