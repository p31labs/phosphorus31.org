    ...
    >
      ...
      {showRainbowArtist && (
        ...
        >
          ...
          <div style={{ color: 'white', fontSize: '18px', fontWeight: 700 }}>Rainbow Artist!</div>
          <div style={{ color: 'white', fontSize: '14px' }}>You used all the colors!</div>
        </div>
      )}
        ...
        {COLORS.map((c) => (
          <button
            ...
            style={{
              ...
              borderRadius: '50%',
              border:
                color === c.color && mode === 'draw' ? '3px solid white' : '2px solid #4B5563',
              background: c.color,
              cursor: 'pointer',
      ...
      <div style={{ display: 'flex', gap: '16px', fontSize: '12px', color: '#6B7280' }}>
        <span>
          Colors: {usedColors.size}/{COLORS.length}
        </span>
