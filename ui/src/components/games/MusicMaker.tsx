...
const NOTES = [
  ...
  { note: 'G', freq: 392.0, color: '#3B82F6', emoji: '🔵' },
  { note: 'A', freq: 440.0, color: '#8B5CF6', emoji: '🟣' },
    ...
    >
      ...
      {showMelody && (
        ...
        >
          ...
          <div style={{ color: 'white', fontSize: '18px', fontWeight: 700 }}>Do-Re-Mi!</div>
          <div style={{ color: 'white', fontSize: '14px' }}>You're making music!</div>
        </div>
      )}
      ...
      {showComposer && (
        ...
        >
          ...
          <div style={{ color: 'white', fontSize: '14px' }}>50 sounds made! Keep creating!</div>
        </div>
      )}
      ...
      {showSecret && (
        ...
        >
          <div style={{ fontSize: '48px' }}>🎵💜🎵</div>
          <div style={{ color: 'white', fontSize: '16px', fontWeight: 700 }}>Secret Melody</div>
          <div style={{ color: 'white', fontSize: '14px', marginTop: '8px' }}>
            "Every song starts with a single note. Every note you play makes the universe a little
            more beautiful."
            <br />
            <br />
