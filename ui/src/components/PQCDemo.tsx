...
export default function PQCDemo() {
  ...
  return (
    ...
    >
      ...
      {/* Results Display */}
      <div
        style={{ display: 'grid', gap: '16px', gridTemplateColumns: '1fr 1fr', fontSize: '12px' }}
      >
        {/* Encryption Results */}
        <div
          style={{
        ...
        >
          ...
          <div style={{ fontFamily: 'monospace', fontSize: '11px', wordBreak: 'break-all' }}>
            ...
            <div>
              Verified:{' '}
              {isVerified === null ? 'Not tested' : isVerified ? '✅ Valid' : '❌ Invalid'}
            </div>
          </div>
        </div>
      </div>
      ...
      <details style={{ marginTop: '20px' }}>
        ...
        >
          <div>
            <strong>ML-KEM-768:</strong> Lattice-based key encapsulation (quantum-resistant)
          </div>
          <div>
            <strong>X25519:</strong> Elliptic curve Diffie-Hellman (classical security)
          </div>
          <div>
            <strong>Hybrid Security:</strong> Protects against both quantum and classical attacks
          </div>
          <div>
            <strong>Key Sizes:</strong> ML-KEM: 1184B public, X25519: 32B public
          </div>
          <div>
            <strong>Shared Secret:</strong> 64B HKDF output for encryption + MAC
          </div>
          <div>
            <strong>Performance:</strong> Keygen ~2ms, Encapsulate ~1ms (ESP32 compatible)
          </div>
        </div>
      </details>
