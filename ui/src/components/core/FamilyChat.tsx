  ...
  if (!initialized) {
    return (
      <div style={{ padding: '20px', textAlign: 'center' }}>
        <div style={{ fontSize: '14px', color: '#9CA3AF' }}>Initializing Family Mesh...</div>
      </div>
    );
  }
      ...
      {members.length > 0 && (
        ...
        >
          {members.map((member) => {
            ...
            const voltageColor =
              member.voltage > 70 ? '#EF4444' : member.voltage > 40 ? '#F59E0B' : '#10B981';
      ...
      >
        {messages.length === 0 ? (
          ...
          >
            ...
            <div style={{ fontWeight: '600', marginBottom: '8px' }}>No messages yet</div>
