  ...
  return (
    ...
    >
      ...
      <section style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <div>
          <label
            style={{ display: 'block', fontSize: '12px', color: '#D1D5DB', marginBottom: '8px' }}
          >
        ...
        {aiProvider === 'ollama' ? (
          ...
          <div>
            ...
            >
              <strong>⚠️ PRIVACY WARNING:</strong> You are sending data to a third-party cloud
              provider. This breaks the local-first privacy model. Only use this if you trust{' '}
              {aiProvider.toUpperCase()} with your data.
            </div>
          </div>
        )}
