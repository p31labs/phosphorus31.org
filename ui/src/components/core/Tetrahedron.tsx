...
export function Tetrahedron({
  ...
  return (
    ...
    >
      <Canvas camera={{ position: [2, 2, 2], fov: 50 }} gl={{ antialias: true, alpha: true }}>
        <TetrahedronScene
          visualization={visualization}
          interactive={interactive}
          onNodeClick={onNodeClick}
        />
        <OrbitControls enableZoom={interactive} enablePan={false} minDistance={2} maxDistance={5} />
      </Canvas>
      ...
      >
        ...
        <span
          style={{
            color:
              visualization.overallHealth > 0.7
