    ...
    >
      ...
      >
        <p style={{ fontSize: '12px', color: '#C084FC', margin: 0 }}>
          <strong>Goal:</strong> Keep entropy (H) near 0.35 (green line) to maintain quantum
          coherence. The molecule becomes jagged and red when decoherent, smooth and blue when
          aligned.
        </p>
      </div>
    </div>
