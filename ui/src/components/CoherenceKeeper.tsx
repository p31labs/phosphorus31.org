    ...
    >
      ...
      >
        ...
        <p style={{ margin: '4px 0' }}>
          FREQ: {frequency.toFixed(3)} Hz (TARGET: {TARGET_FREQUENCY})
        </p>
        <p style={{ margin: '4px 0' }}>COHERENCE: {coherence.toFixed(1)}%</p>
        <div
          style={{ width: '200px', height: '20px', border: '1px solid cyan', marginTop: '10px' }}
        >
          <div
            style={{
              width: `${coherence}%`,
              height: '100%',
              background: coherence > 90 ? 'white' : 'cyan',
            }}
          />
        </div>
      </div>
