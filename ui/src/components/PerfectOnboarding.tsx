...
const ONBOARDING_STEPS = [
  ...
  },
  {
    ...
    description:
      "Everything begins with the tetrahedron - the fundamental unit of 3D space, quantum measurement, and Fuller's synergetic geometry. SIC-POVM measurements verify your creations.",
    visual: 'tetrahedron',
    duration: 10000,
    interactive: true,
  ...
  },
  {
    ...
    description:
      'Your data never leaves your device. Post-quantum cryptography (ML-KEM-768 + X25519) protects your work. Hardware roots your identity in silicon.',
    visual: 'shield',
    duration: 8000,
    interactive: false,
  ...
  },
  {
    ...
    description:
      'QG-IDE brings together Godot game engine, Luanti voxel worlds, quantum entanglement bridges, and hardware synthesis - all in your browser.',
    visual: 'tools',
    duration: 12000,
    interactive: true,
  ...
  },
  {
    ...
    description:
      'Experience quantum biology through play. Maintain molecular coherence by balancing entropy and stability. This is quantum physics made tangible.',
    visual: 'quest',
    duration: 15000,
    interactive: true,
  ...
  },
  {
    ...
    description:
      "You now hold the keys to quantum-secure creation. Build games, explore voxel worlds, manipulate quantum states, and push the boundaries of what's possible.",
    visual: 'launch',
    duration: 8000,
    interactive: false,
      ...
      <group>
        {[
          ...
          <line key={i}>
            ...
            <lineBasicMaterial color="#06b6d4" opacity={progress > 0.3 ? 0.6 : 0} transparent />
          </line>
        ))}
      </group>
    </group>
      ...
      {tools.map((tool, i) => {
        ...
        return (
          <group key={tool.name} position={tool.position as [number, number, number]}>
            <Box args={[1, 1, 0.2]} scale={isActive ? [1, 1, 1] : [0.1, 0.1, 0.1]}>
              <meshStandardMaterial
                color={tool.color}
                emissive={tool.color}
  ...
  return (
    <group>
      ...
      {Array.from({ length: 9 }).map((_, i) => {
        ...
        return (
          <Sphere key={`ca-${i}`} args={[0.15]} position={[x, y, z]}>
      ...
      {Array.from({ length: 6 }).map((_, i) => {
        ...
        return (
          <Tetrahedron key={`po4-${i}`} args={[0.3]} position={[x, 0, z]}>
            <meshStandardMaterial color="#ec4899" emissive="#ec4899" emissiveIntensity={0.3} />
          </Tetrahedron>
        );
      })}
  ...
  return (
    <group>
      ...
      {[2, 3, 4, 5].map((radius, i) => (
        <Torus key={i} args={[radius, 0.05, 8, 32]} rotation={[Math.PI / 2, 0, 0]}>
          <meshStandardMaterial
            color="#06b6d4"
            emissive="#06b6d4"
            emissiveIntensity={0.3}
...
export default function PerfectOnboarding({
  onComplete,
  onNavigateToCoherenceQuest,
}: PerfectOnboardingProps = {}) {
  ...
  const renderVisual = () => {
    ...
    switch (currentStepData.visual) {
      case 'universe':
        return <UniverseVisual {...props} />;
      case 'tetrahedron':
        return <TetrahedronVisual {...props} />;
      case 'shield':
        return <ShieldVisual {...props} />;
      case 'tools':
        return <ToolsVisual {...props} />;
      case 'quest':
        return <QuestVisual {...props} />;
      case 'hardware':
        return <HardwareVisual {...props} />;
      case 'launch':
        return <LaunchVisual {...props} />;
      default:
        return <UniverseVisual {...props} />;
    }
  };
            ...
            {currentStepData.interactive && (
              ...
              >
                {currentStep === 1 && (
                  <div>
                    <p style={{ color: '#d1d5db', marginBottom: '1rem' }}>
                      Try rotating the tetrahedron with your mouse to explore quantum measurement
                      points!
                    </p>
                ...
                {currentStep === 4 && (
                  <div>
                    <p style={{ color: '#d1d5db', marginBottom: '1rem' }}>
                      Ready to try the Coherence Quest? This quantum molecule builder teaches
                      through play.
                    </p>
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
                      <button
