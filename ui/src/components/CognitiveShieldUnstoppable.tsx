...
export default function CognitiveShieldUnstoppable() {
  ...
  const getPowerIcon = (source: string) => {
    switch (source) {
      ...
      case 'wind':
        return <Wind size={14} style={{ color: '#06b6d4' }} />;
      case 'battery':
        return <Battery size={14} style={{ color: '#22c55e' }} />;
      case 'kinetic':
  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: '0.7rem' }}>
                223 nodes • 1,456 connections • 99.7% uptime
              </span>
            </div>
          </div>
          ...
          >
            {nodes.map((node) => (
              ...
              >
                ...
                >
                  <div style={{ color: getStatusColor(node.status) }}>{getNodeIcon(node.type)}</div>
                  <div>
                    <div
                      style={{
                        fontSize: '0.9rem',
                ...
                >
                  ...
                  <div>
                    ...
                    <span
                      style={{
                        color:
                          node.processingLoad > 80
                            ? '#ef4444'
                            : node.processingLoad > 60
                              ? '#f97316'
                              : '#22c55e',
                        marginLeft: '0.25rem',
                      }}
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  Peer-to-peer mesh with LoRa, satellite, and radio links. No central points of
                  failure.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <span style={{ fontSize: '0.9rem', fontWeight: '600', color: '#8b5cf6' }}>1,456</span>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  Automatic node deployment, load balancing, and failure recovery. System adapts and
                  survives.
                </p>
              </div>
            </div>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                All systems operating autonomously. Mesh network engaged. Energy independence
                active.
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#dc2626' }}>∞</div>
              <div style={{ fontSize: '0.8rem', color: '#991b1b' }}>Hours of Autonomy</div>
            </div>
            ...
            >
              <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#dc2626' }}>99.9%</div>
              <div style={{ fontSize: '0.8rem', color: '#991b1b' }}>Network Uptime</div>
            </div>
            ...
            >
              ...
              <div style={{ fontSize: '0.8rem', color: '#991b1b' }}>External Dependencies</div>
            </div>
          </div>
        </div>
      )}
      ...
      >
        ...
        >
          When grids fail, when networks collapse, when governments fall - we persist. Distributed,
