...
export default function QuickStartGuide() {
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      description:
        'Paste a message in the Shield tab to see how it analyzes communication patterns and suggests responses.',
      icon: <Zap size={24} />,
      action: {
        label: 'Try Shield',
    ...
    },
    {
      ...
      description:
        'Learn about the four-node communication model that makes understanding possible across different HumanOS types.',
      icon: <Box size={24} />,
      action: {
        label: 'Explore',
    ...
    },
    {
      ...
      description:
        'Experience quantum physics through gameplay. Build molecules and learn about coherence in a fun, interactive way.',
      icon: <Code2 size={24} />,
      action: {
        label: 'Play Game',
    ...
    },
    {
      ...
      title: 'Meet PHENIX',
      description:
        'Your AI companion for navigation, equilibrium, and integrated exchange. Get personalized guidance and support.',
      icon: <Rocket size={24} />,
      action: {
        label: 'Meet PHENIX',
        onClick: () => {
    ...
    >
      ...
      {completedCount === totalSteps && (
        ...
        >
          ...
          >
            You're now ready to explore the full power of sovereign development. Check out the
            Tetrahedron Protocol and try building your first quantum application.
          </p>
        </div>
      )}
      ...
      >
        ...
        >
          ...
          or visit our{' '}
          <a href="#faq" style={{ color: GOD_CONFIG.theme.text.accent, textDecoration: 'none' }}>
            FAQ
          </a>{' '}
          for more guidance.
        </p>
