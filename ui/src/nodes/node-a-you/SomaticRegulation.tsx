...
export function SomaticRegulation() {
  ...
  const initiateAirlock = useCallback(
    async (target: AirlockState['currentContext']) => {
  ...
  const getRASColor = () => {
    switch (rasLevel) {
      case 'hypo':
        return GOD_CONFIG.voltage.low.color;
      case 'optimal':
  ...
  const getRASLabel = () => {
    switch (rasLevel) {
      case 'hypo':
        return 'Under-Aroused (The Drift)';
      case 'optimal':
        return 'Optimal (Flow State)';
      case 'hyper':
        return 'Over-Aroused (Redline)';
    }
  };
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      >
        ...
        <p style={{ margin: 0, fontSize: 13, color: GOD_CONFIG.theme.text.secondary }}>
          The "Race Car Brain" maintenance system. Sensory regulation for the high-performance
          neurotype.
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 10, color: GOD_CONFIG.theme.text.muted }}>Trigeminal Shock</div>
        </button>
        ...
        >
          ...
          <div
            style={{
              fontSize: 10,
              color: isBrownNoiseOn ? '#6366f1' : GOD_CONFIG.theme.text.muted,
            }}
          >
      ...
      {showVoidWarning && (
        ...
        >
          ...
          {sensoryVoids.map((v, i) => (
            <div
              key={i}
              style={{ fontSize: 12, color: GOD_CONFIG.theme.text.secondary, marginLeft: 24 }}
            >
              • {v}
            </div>
          ))}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            >
              ...
              <div style={{ fontSize: 32, marginTop: 8 }}>
                {contextIcons[airlock.currentContext]}
              </div>
              <div
                style={{
                  fontSize: 14,
              ...
              {(Object.keys(contextIcons) as AirlockState['currentContext'][]).map((ctx) => (
                <button
                  ...
                  style={{
                    padding: 12,
                    backgroundColor:
                      airlock.currentContext === ctx
                        ? GOD_CONFIG.theme.text.accent
                        : GOD_CONFIG.theme.bg.tertiary,
                    border: 'none',
                    borderRadius: 8,
                    cursor:
                      airlock.isTransitioning || airlock.currentContext === ctx
                        ? 'not-allowed'
                        : 'pointer',
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: 10,
                      color:
                        airlock.currentContext === ctx ? '#fff' : GOD_CONFIG.theme.text.primary,
                    }}
                  >
                    {ctx}
                  </span>
            ...
            >
              "The Airlock prevents the 'bends' when moving between high-pressure and low-pressure
              environments."
            </div>
          </div>
        )}
                  ...
                  <>
                    <button
                      ...
                      style={{
                        padding: '6px 12px',
                        backgroundColor: '#1a2e1a',
                        border: `1px solid ${GOD_CONFIG.heartbeat.statuses.green.color}`,
                        borderRadius: 6,
                        color: GOD_CONFIG.heartbeat.statuses.green.color,
                        fontSize: 11,
                        cursor: 'pointer',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'flex', gap: 12, alignItems: 'flex-end' }}>
              ...
              <button
                ...
                style={{
                  padding: '10px 16px',
                  backgroundColor: currentActivity.trim()
            ...
            <div>
              ...
              {heavyWorkLog.length === 0 ? (
                <div
                  style={{ fontSize: 12, color: GOD_CONFIG.theme.text.muted, fontStyle: 'italic' }}
                >
