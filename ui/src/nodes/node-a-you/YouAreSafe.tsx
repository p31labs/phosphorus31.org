...
export function YouAreSafe({ isOpen, onClose, initialNode, payload }: YouAreSafeProps) {
  ...
  const [selectedBreathing, setSelectedBreathing] = useState<BreathingExercise>('box');
  ...
  const getSpoonColor = () => {
    if (spoonsRemaining >= GOD_CONFIG.spoons.thresholds.healthy)
      return GOD_CONFIG.voltage.low.color;
    if (spoonsRemaining >= GOD_CONFIG.spoons.thresholds.caution)
      ...
      >
        ...
        >
          ...
          >
              ...
              {Array.from({ length: GOD_CONFIG.spoons.max }).map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 4,
                    backgroundColor:
                      i < spoonsRemaining ? getSpoonColor() : GOD_CONFIG.theme.bg.accent,
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <button
                ...
                aria-label="Decrease cognitive energy by one spoon"
                onFocus={(e) => {
                  e.currentTarget.style.outline = '3px solid #6366f1';
                  e.currentTarget.style.outlineOffset = '2px';
                }}
              ...
              <button
                ...
                aria-label="Increase cognitive energy by one spoon"
                onFocus={(e) => {
                  e.currentTarget.style.outline = '3px solid #6366f1';
                  e.currentTarget.style.outlineOffset = '2px';
                }}
              ...
              <button
                ...
                onKeyDown={(e) => {
                  if (e.key === 'Enter' || e.key === ' ') {
                    e.preventDefault();
                    setSpoonsRemaining(GOD_CONFIG.spoons.max);
                  }
                }}
                style={{
                  padding: '8px 12px',
                ...
                aria-label="Reset cognitive energy to maximum"
                onFocus={(e) => {
                  e.currentTarget.style.outline = '3px solid #6366f1';
                  e.currentTarget.style.outlineOffset = '2px';
                }}
            ...
            {spoonsRemaining <= GOD_CONFIG.spoons.thresholds.critical && (
              ...
              >
                ⚠️ <strong>Critical energy level.</strong> You have permission to stop. Rest is not
                failure—it is mandatory maintenance.
              </div>
            )}
          </div>
          ...
          <button
            ...
            aria-label={
              showReassurance ? 'Hide core reassurance messages' : 'Show core reassurance messages'
            }
            onFocus={(e) => {
              e.currentTarget.style.outline = '3px solid #6366f1';
              e.currentTarget.style.outlineOffset = '2px';
              ...
              {nodeEntries.map(([key, node]) => (
                <button
                  ...
                  style={{
                    ...
                    minHeight: '44px',
                    backgroundColor:
                      activeNode === key ? `${node.color}20` : GOD_CONFIG.theme.bg.tertiary,
                    border: `1px solid ${
                      activeNode === key ? node.color : GOD_CONFIG.theme.border.default
                    }`,
                    borderRadius: 10,
                    cursor: 'pointer',
                    textAlign: 'left',
                  ...
                  aria-expanded={activeNode === key}
                  aria-label={`${activeNode === key ? 'Close' : 'Open'} ${node.name} safety node`}
                  onFocus={(e) => {
                    e.currentTarget.style.outline = '3px solid #6366f1';
                    e.currentTarget.style.outlineOffset = '2px';
                  }}
          ...
          >
            ...
            >
              ...
              <select
                value={String(selectedBreathing)}
                onChange={(e) => {
              ...
              >
                <div
                  style={{
                    ...
                    transform:
                      breathPhases[breathPhase] === 'Inhale'
                        ? 'scale(1.2)'
            ...
            <button
              ...
              aria-label={
                isBreathing
                  ...
                  : `Start ${breathingExercise.name} breathing exercise`
              }
              onFocus={(e) => {
                e.currentTarget.style.outline = '3px solid #6366f1';
                e.currentTarget.style.outlineOffset = '2px';
