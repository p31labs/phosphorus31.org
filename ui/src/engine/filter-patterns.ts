 ...
 */
export type ThreatCategory = 'legal' | 'emotional' | 'financial' | 'gaslighting' | 'pressure' | 'general';
...
export const DEFAULT_THREAT_PATTERNS: ExtendedThreatPattern[] = [
  // Legal threats
  {
    ...
    name: 'Legal Threat',
    category: 'legal',
    pattern: /(i'm going to take you to court|taking you to court|suing you|file (a|an) (lawsuit|suit)|my attorney|my lawyer|legal action|legal proceedings|we file|filing against)/i,
    severity: 'critical',
  ...
  },
  {
    ...
    name: 'Legal Pressure',
    category: 'legal',
    pattern: /(you have until|deadline to respond|or we file|or else we|before we take|legal consequences)/i,
    severity: 'high',
  ...
  // Emotional manipulation
  {
    ...
    category: 'emotional',
    pattern: /(you (always|never) (do|think|say|are)|you're (always|never)|this is all your fault|everything is your fault)/i,
    severity: 'high',
  ...
  },
  {
    ...
    name: 'Blame Shifting',
    category: 'emotional',
    pattern: /(this is all your fault|it's your fault|you caused this|you're to blame|because of you)/i,
    severity: 'high',
  ...
  // Financial coercion
  {
    ...
    category: 'financial',
    pattern: /(you owe me|you owe us|owe \$\d+|wages garnished|garnish your wages|child support|alimony|payment due)/i,
    severity: 'high',
  ...
  },
  {
    ...
    category: 'financial',
    pattern: /(i'll (have|get) your (wages|paycheck) (garnished|seized)|collection agency|debt collector)/i,
    severity: 'critical',
  ...
  // Gaslighting
  {
    ...
    pattern: /(that (never|didn't) happen|that never happened|that's not what happened|you're (remembering|imagining) (it|that) wrong)/i,
    severity: 'critical',
  ...
  },
  {
    ...
    category: 'gaslighting',
    pattern: /(you're (overreacting|being (dramatic|crazy)|crazy|insane|paranoid)|you're imagining things|everyone thinks you're (the problem|crazy|wrong))/i,
    severity: 'critical',
  ...
  },
  {
    ...
    name: 'Gaslighting',
    category: 'gaslighting',
    pattern: /(that (never|didn't) happen|you're (remembering|imagining) (it|that) wrong|you're (overreacting|being (dramatic|crazy)))/i,
    severity: 'critical',
  ...
  // Deadline pressure
  {
    ...
    name: 'Urgent Demand',
    category: 'pressure',
    pattern: /(urgent|asap|immediately|right now|drop everything|you need to decide (right now|immediately)|this is your (last chance|final chance))/i,
    severity: 'high',
  ...
  },
  {
    ...
    category: 'pressure',
    pattern: /(if you don't (respond|reply|answer) (by|before)|you have until|deadline is|must respond by|last chance|final warning)/i,
    severity: 'high',
