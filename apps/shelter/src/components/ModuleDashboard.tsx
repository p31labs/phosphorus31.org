...
function ModuleImportPanel({
  ...
  onClose: () => void;
  onImport: (module: GeodesicModule) => void;
}) {
      ...
      >
        ...
        <div style={{ padding: 20 }}>
          {success ? (
            ...
            >
              <Check size={48} />
              <div style={{ marginTop: 12, fontSize: 16, fontWeight: 600 }}>Module Imported!</div>
            </div>
          ) : (
            <>
              ...
              <button
                ...
                style={{
                  ...
                  marginTop: 16,
                  padding: '12px 20px',
                  backgroundColor: importText.trim()
                    ? GOD_CONFIG.heartbeat.statuses.green.color
    ...
    <div style={{ padding: 20, maxWidth: 1200, margin: '0 auto' }}>
      ...
      {enabledModules.length === 0 && (
        ...
        >
          ...
          >
            Create a module in the Module Maker, or import one from the community. Then enable it in
            the Module Manager to see it here.
          </p>
