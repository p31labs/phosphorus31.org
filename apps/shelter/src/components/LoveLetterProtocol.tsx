...
const PROTOCOL_STEPS: ProtocolStep[] = [
  {
    ...
    prompt:
      'Close your eyes. Take three breaths. When you open them, write one word that describes how your body feels right now.',
  ...
  },
  {
    ...
    prompt:
      'Without defending yourself, write what you imagine she might be experiencing. What fears? What exhaustion? What hopes?',
  ...
  },
  {
    ...
    prompt:
      "What is one thing you did (or didn't do) that contributed to the distance? Not the whole war. Just one battle you could have fought differently.",
  ...
  },
  {
    ...
    prompt:
      'Underneath the anger, underneath the frustration, what do you actually need? Not what you want her to do. What you need to feel.',
  ...
  },
  {
    ...
    prompt:
      'What are you willing to give? Not as a transaction, but as an offering. What can you do differently? What can you let go of?',
  ...
  },
  {
    ...
    prompt:
      'What is one small thing you would like? Something she could actually do, that would help you feel connected. Something you can ask for without resentment if she says no.',
      ...
      >
        ...
        >
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 14, color: GOD_CONFIG.theme.text.secondary }}>of 3 breaths</div>
          </div>
        </div>
  ...
  return (
    <div style={{ maxWidth: 600, margin: '0 auto', padding: 20 }}>
      ...
      >
        ...
        >
          "To truly love someone is to engineer your signal so it can enter their system without
          burning."
        </p>
      </div>
          ...
          >
            <button
              ...
              style={{
                ...
                padding: '12px 20px',
                backgroundColor:
                  currentStep === 0 ? GOD_CONFIG.theme.bg.tertiary : GOD_CONFIG.theme.bg.secondary,
                border: `1px solid ${GOD_CONFIG.theme.border.default}`,
                borderRadius: 8,
                color:
                  currentStep === 0 ? GOD_CONFIG.theme.text.muted : GOD_CONFIG.theme.text.primary,
                fontSize: 14,
      ...
      >
        ...
        Everything you write here stays on your device. No servers. No storage. Just you and your
        words.
      </div>
    </div>
  );
