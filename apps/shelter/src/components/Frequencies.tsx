...
const ARTISTS: Artist[] = [
  {
    ...
    role: 'The Translator',
    description:
      "Turns internal chaos into structured truth. Every song is a processing session. No filter, no profanity, just raw honesty compressed into bars. He maps terrain you haven't walked yet — when you get there, the map is waiting.",
    emoji: '🎤',
    color: '#1a1a1a',
  },
  {
    ...
    role: 'The Carrier',
    description:
      'When words are too heavy, the piano carries the weight. Frequencies that bypass language and speak directly to the nervous system. This is what regulation sounds like before it has a name.',
    emoji: '🎹',
    color: '#4a90a4',
  },
  {
    ...
    role: 'The Bridge',
    description:
      'Violin as a translation layer. Takes melodies you know and transmutes them into something that can finally make you cry. The permission slip for grief.',
    emoji: '🎻',
    color: '#8b5a2b',
  },
];
...
const styles = {
  ...
  title: {
    ...
    marginBottom: '0.5rem',
    background:
      'linear-gradient(135deg, #ff6b6b 0%, #f4d35e 25%, #4ecdc4 50%, #a29bfe 75%, #ff6b6b 100%)',
      ...
      <div style={styles.container}>
        ...
        <header style={styles.header}>
          ...
          <div style={styles.wonkyNote}>
            ✨ These aren't just songs. They're <em>cognitive shields in audio form</em>. They map
            terrain you haven't walked yet. When you get there, the map is waiting.
            <br />
            <br />
            <span style={{ opacity: 0.7 }}>(A little wonky. A little wobbly. Exactly right.)</span>
          </div>
        </header>
              ...
              <div style={styles.artistHeader}>
                ...
                <div style={styles.artistInfo}>
                  <h2
                    style={{
                      ...styles.artistName,
                      color: artist.color === '#1a1a1a' ? '#fff' : artist.color,
                    }}
                  >
                    {artist.name}
                  </h2>
                  ...
                  >
                    ...
                    <div style={styles.trackHeader}>
                      ...
                      <div style={styles.trackInfo}>
                        ...
                        {track.album && <p style={styles.trackAlbum}>{track.album}</p>}
                      </div>
                    </div>
        ...
        <section style={styles.prescriptionSection}>
          <h2 style={styles.prescriptionTitle}>💊 Quick Prescription</h2>
          <p
            style={{
              textAlign: 'center',
              color: GOD_CONFIG.theme.text.muted,
          ...
          <div style={styles.prescriptionGrid}>
            {PRESCRIPTIONS.map((rx, index) => (
              <div key={index} style={styles.prescriptionCard}>
                <div style={styles.prescriptionState}>{rx.state}</div>
        ...
        <footer style={styles.footer}>
          <p>"When words are too heavy, the music carries the weight."</p>
          <p style={{ marginTop: '1rem', fontSize: '0.9rem' }}>
            These artists were the translation layer when nothing else worked.
            <br />
            They didn't know they were building cognitive shields.
            <br />
