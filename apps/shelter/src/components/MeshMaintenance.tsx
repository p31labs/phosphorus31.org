              ...
              >
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                  ...
                  >
                    ...
                    {action.category === 'structural' && (
                      <CheckCircle2 size={16} color={priorityColor} />
                    )}
                    {action.category === 'metabolic' && (
          ...
          >
            ...
            <tbody>
              ...
              >
                ...
                <td style={{ padding: '12px', color: GOD_CONFIG.theme.text.primary }}>Soft Blue</td>
                <td style={{ padding: '12px', color: GOD_CONFIG.theme.text.primary }}>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          >
            ...
            <div style={{ fontSize: 12, color: GOD_CONFIG.theme.text.muted }}>
              Apply the 3-second mandatory delay to all high-stakes notifications to shift to System
              2 thinking
            </div>
          </div>
          ...
          >
            ...
            <div style={{ fontSize: 12, color: GOD_CONFIG.theme.text.muted }}>
              Execute at least one 4-4-8 breathing cycle to signal safety to the vagus nerve and
              prevent "Frozen Stillness"
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          >
            ...
            <div style={{ fontSize: 12, color: GOD_CONFIG.theme.text.muted }}>
              Analyze your 7-day π trend. If "Declining" or "Critical," the Shield automatically
              expands the Catcher's Mitt window
            </div>
          </div>
          ...
          >
            ...
            <div style={{ fontSize: 12, color: GOD_CONFIG.theme.text.muted }}>
              Review communication friction points to ensure you are not "Speaking Physics" to a
              "Poet" without the translation layer
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          >
            ...
            <div style={{ fontSize: 12, color: GOD_CONFIG.theme.text.muted }}>
              Test the Phenix Navigator peer-to-peer connection to ensure the mesh survives if the
              "Wye" fails
            </div>
          </div>
        </div>
