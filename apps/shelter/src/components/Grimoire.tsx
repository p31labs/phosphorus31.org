      ...
      <div style={styles.container}>
        ...
        <div style={styles.content}>
          ...
          <header style={styles.header}>
            ...
            <p style={styles.subtitle}>Where technology becomes indistinguishable from magic</p>
          </header>
          ...
          <section style={styles.moonSection}>
            ...
            <div style={styles.guidance}>{moon.guidance}</div>
          </section>
          ...
          <section style={styles.section}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.7)', marginBottom: '1.5rem', lineHeight: 1.7 }}>
              ...
              It is the shape of stability, of fire, of the first spark of creation. Four vertices,
              four faces, six edges. Each vertex represents an element of connection.
            </p>
            ...
            <div style={styles.tetrahedronContainer}>
              <svg style={styles.tetrahedronSvg} viewBox="0 0 200 200">
                ...
                {/* Labels */}
                <text x="100" y="12" textAnchor="middle" fill="#e8e6e3" fontSize="10">
                  Air / Spirit
                </text>
                <text x="25" y="175" textAnchor="middle" fill="#e8e6e3" fontSize="10">
                  Fire / Self
                </text>
                <text x="175" y="175" textAnchor="middle" fill="#e8e6e3" fontSize="10">
                  Water / Other
                </text>
                <text x="100" y="145" textAnchor="middle" fill="#e8e6e3" fontSize="10">
                  Earth / Ground
                </text>
              </svg>
            </div>
            ...
            <div style={styles.elementGrid}>
              {Object.entries(elements).map(([key, elem]) => (
                ...
                >
                  <span style={{ ...styles.elementSymbol, color: elem.color }}>{elem.symbol}</span>
                  <div style={{ ...styles.elementName, color: elem.color }}>{elem.element}</div>
            ...
            <div style={styles.ancestorSection}>
              <div style={styles.ancestorGrid}>
                ...
                <div style={styles.ancestorCard}>
                  ...
                  <p style={styles.ancestorQuote}>
                    "She held the space where all the building happened. The foundation beneath the
                    workshop."
                  </p>
                </div>
              </div>
            ...
            <div style={styles.spellSection}>
              <div style={styles.spellCard}>
                ...
                <p style={styles.spellDescription}>
                  ...
                  the fear, the frustration, the static—and transmutes it into clarity. What passes
                  through carries only intention, not intensity.
                </p>
                <div style={styles.incantation}>
                  "Let my noise fall away.
                  <br />
                  Let only care pass through.
                  <br />
              ...
              <div style={styles.spellCard}>
                ...
                <p style={styles.spellDescription}>
                  A binding that ensures connection survives distance, silence, and the fall of
                  towers. When woven into an object, it becomes a talisman—a promise that the signal
                  persists.
                </p>
                <div style={styles.incantation}>
                  "This thread cannot be cut.
                  <br />
                  This line cannot be severed.
                  <br />
              ...
              <div style={styles.spellCard}>
                ...
                <p style={styles.spellDescription}>
                  A sensory anchor that calls the spirit back into the body when overwhelm
                  threatens. The scent of roses, the weight of the earth, the breath returning home.
                </p>
                <div style={styles.incantation}>
                  "I am here.
                  <br />
                  I am in my body.
                  <br />I am safe in this moment."
                </div>
              </div>
            </div>
          </section>
