...
const FEATURES: Feature[] = [
  // CORE
  {
    ...
    icon: Shield,
    description:
      'Analyzes incoming messages for emotional voltage, genre, and potential triggers. Transforms high-voltage content into receivable form.',
    howTo: [
  ...
  },
  {
    ...
    icon: Send,
    description:
      'AI-assisted response generation with tone control. Creates regulated responses to difficult messages.',
    howTo: [
  ...
  },
  {
    ...
    icon: Heart,
    description:
      "4-node validation check before high-stakes communication. Ensures you're grounded and ready.",
    howTo: [
  ...
  // SOMATIC
  {
    ...
    icon: Zap,
    description:
      'Trigeminal nerve activation using ice + lime + salt. Jolts the RAS into high-alert state for focus.',
    howTo: [
      'Go to Somatic tab',
  ...
  },
  {
    ...
    icon: Flower2,
    description:
      'Haptic anchor like counting rosary beads. Each press grounds you in the physical Now.',
    howTo: [
      'Go to Somatic tab',
  ...
  },
  {
    ...
    icon: Volume2,
    description:
      'Built-in audio for focus. Occupies the under-stimulated brain without overwhelming.',
    howTo: [
      'Go to Somatic tab',
  ...
  },
  {
    ...
    icon: DoorOpen,
    description:
      'Context-switching pressure equalization. Prevents the "bends" when moving between environments.',
    howTo: [
  ...
  },
  {
    ...
    icon: Hammer,
    description:
      'Log physical regulation activities. Earn spoons back through proprioceptive work.',
    howTo: [
  ...
  // NETWORK
  {
    ...
    icon: Radio,
    description:
      'Peer-to-peer connection via WebRTC. Direct encrypted links between family members.',
    howTo: [
      'Go to Heartbeat tab',
      'Copy your Node ID',
  ...
  },
  {
    ...
    icon: Box,
    description:
      '4-node geometry for structural stability. The minimum stable structure in 3D space.',
    howTo: [
...
export function FeatureShowcase() {
  ...
  return (
    <div
      style={{ display: 'flex', flexDirection: 'column', gap: 20, maxWidth: 900, margin: '0 auto' }}
    >
      {/* Header */}
      <div
        style={{
      ...
      >
        ...
        <h2
          style={{ margin: 0, fontSize: 24, fontWeight: 700, color: GOD_CONFIG.theme.text.primary }}
        >
          Feature Showcase
        </h2>
          ...
          return (
            <button
              ...
              style={{
                padding: '8px 16px',
                backgroundColor:
                  selectedCategory === cat.id ? cat.color : GOD_CONFIG.theme.bg.tertiary,
                border: 'none',
                borderRadius: 6,
