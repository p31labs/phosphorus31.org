            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    Expected: {payload.expectedVoltage.toFixed(1)} voltage, {payload.expectedSpoons}{' '}
                    spoons
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          <div style={{ fontSize: 13, color: GOD_CONFIG.theme.text.primary }}>
            • <strong>Tetrahedron Protocol</strong>: Navigate to Tetrahedron tab to verify SIC-POVM
            symmetry
          </div>
          <div style={{ fontSize: 13, color: GOD_CONFIG.theme.text.primary }}>
