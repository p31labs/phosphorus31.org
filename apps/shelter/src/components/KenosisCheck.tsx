...
export function KenosisCheck() {
  ...
  const allPassed = Array.from(verificationResults.values()).every((v) => v);
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      {allPassed && verificationComplete && (
        ...
        >
          ...
          >
            The Digital Centaur stack has passed all structural integrity checks. The system is
            ready for the transition from <strong>Apparent Authority</strong> to{' '}
            <strong>Actual Authority</strong>. The Abdication Ceremony can proceed when you are
            ready.
          </p>
        </div>
      )}
