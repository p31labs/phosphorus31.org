...
export function ModuleManager() {
  const { installedModules, enabledModuleIds, enableModule, disableModule, uninstallModule } =
    useModuleStore();
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {enabledModules.map((module) => (
                <ModuleCard
                  ...
                  onDelete={() => {
                    setShowDeleteConfirm(module.id);
                  }}
                />
              ))}
            </div>
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 14, color: GOD_CONFIG.theme.text.secondary, marginBottom: 20 }}>
              This will permanently remove the module from your system. This action cannot be
              undone.
            </p>
            <div style={{ display: 'flex', gap: 12, justifyContent: 'flex-end' }}>
              ...
              <button
                onClick={() => {
                  handleUninstall(showDeleteConfirm);
                }}
                style={{
                  padding: '10px 20px',
    ...
    >
      ...
      >
        <div style={{ flex: 1 }}>
          ...
          <div
            style={{ display: 'flex', gap: 12, fontSize: 11, color: GOD_CONFIG.theme.text.muted }}
          >
              ...
              {module.linterReport.violations.map((violation, i) => (
                ...
                >
                  ...
                  {violation.suggestion && (
                    <div
                      style={{ fontSize: 12, color: GOD_CONFIG.theme.text.secondary, marginTop: 4 }}
                    >
                      💡 {violation.suggestion}
                    </div>
                  )}
