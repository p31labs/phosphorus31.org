...
export const FamilyConstellation: React.FC = () => {
    ...
    if (connectMode) {
      if (selectedStar && selectedStar !== starId) {
        ...
        const exists = connections.some(
          (c) =>
            (c.from === selectedStar && c.to === starId) ||
  ...
  const addWish = () => {
    if (wishTarget) {
      setFamily((prev) =>
        prev.map((star) => (star.id === wishTarget ? { ...star, wish: wishText } : star))
      );
      ...
      <div style={styles.container}>
        ...
        <div ref={canvasRef} style={styles.canvas}>
          ...
          {family.map((star) => (
            ...
            >
              ...
              {star.wish && <span style={styles.wishDisplay}>"{star.wish}"</span>}
            </div>
          ))}
        </div>
        ...
        <div style={styles.controls}>
          ...
          {isComplete && (
            <div style={styles.message}>
              🌟 <strong>Your constellation is complete!</strong>
              <br />
        ...
        {showWishModal && (
          ...
          >
            ...
            >
              <h3 style={styles.modalTitle}>Make a Wish ✨</h3>
              <p
                style={{
                  color: 'rgba(255,255,255,0.7)',
                  marginBottom: '1rem',
              ...
              >
                <button onClick={addWish} style={{ ...styles.button, ...styles.primaryButton }}>
                  ✨ Add Wish
                </button>
                <button
                  onClick={() => {
        ...
        {showAddModal && (
          ...
          >
            ...
            >
              <h3 style={styles.modalTitle}>Add a Star ⭐</h3>
              <p
                style={{
                  color: 'rgba(255,255,255,0.7)',
                  marginBottom: '1rem',
              ...
              >
                {[
                  ...
                  <button
                    key={emoji}
                    onClick={() => {
                      setNewStarEmoji(emoji);
                    }}
                    style={{
                      padding: '8px',
                      fontSize: '1.5rem',
                      background:
                        newStarEmoji === emoji ? 'rgba(244,211,94,0.3)' : 'rgba(255,255,255,0.1)',
                      border:
                        newStarEmoji === emoji
                          ? '2px solid #f4d35e'
