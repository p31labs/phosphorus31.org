...
export const GOD_CONFIG = {
  ...
  // === VOLTAGE LEVELS ===
  voltage: {
    low: { label: 'Low', color: '#00FF88', threshold: 0.33 },
    medium: { label: 'Medium', color: '#FFB800', threshold: 0.66 },
    high: { label: 'High', color: '#FF00CC', threshold: 1.0 },
  } as const,
  ...
  theme: {
    ...
    gradient: {
      shield: 'linear-gradient(135deg, #00FF88 0%, #00D4FF 50%, #00D4FF 100%)',
      voltage: {
        low: 'linear-gradient(90deg, #00FF88, #00b861)',
        medium: 'linear-gradient(90deg, #FFB800, #cc9300)',
        high: 'linear-gradient(90deg, #FF00CC, #cc00a3)',
      },
    },
  },

  // === TYPOGRAPHY (P31 brand: Oxanium + Space Mono) ===
  typography: {
    fontFamily: {
