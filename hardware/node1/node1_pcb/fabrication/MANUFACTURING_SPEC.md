...
- [x] node1-F_Cu.gbr (Top Copper)
- [x] node1-B_Cu.gbr (Bottom Copper)
- [x] node1-F_Mask.gbr (Top Solder Mask)
- [x] node1-B_Mask.gbr (Bottom Solder Mask)
- [x] node1-F_SilkS.gbr (Top Silkscreen)
- [x] node1-B_SilkS.gbr (Bottom Silkscreen)
- [x] node1-Edge_Cuts.gbr (Board Outline)
- [x] node1.drl (Drill file)
