...
The Sensory Cyberdeck is a "Board is the Product" design philosophy embodied in a 51mm x 51mm PCB that celebrates electronics rather than hiding them. This project combines:
...
```
sensory_cyberdeck_pcb/
├── gerbers/                          # Manufacturing files
│   ├── sensory_cyberdeck-F_Cu.gbr   # Top copper layer
│   ├── sensory_cyberdeck-B_Cu.gbr   # Bottom copper (ground plane)
│   ├── sensory_cyberdeck-F_Mask.gbr # Top solder mask
│   ├── sensory_cyberdeck-B_Mask.gbr # Bottom solder mask (with touch zones)
│   ├── sensory_cyberdeck-F_SilkS.gbr # Top silkscreen
│   ├── sensory_cyberdeck-B_SilkS.gbr # Bottom silkscreen
│   ├── sensory_cyberdeck-Edge_Cuts.gbr # Board outline
│   └── sensory_cyberdeck.drl        # Drill file
├── fabrication/
...
├── sensory_cyberdeck.kicad_pro      # KiCad project file
└── README.md                        # This file
```
