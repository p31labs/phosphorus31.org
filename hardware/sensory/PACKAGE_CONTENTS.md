# Sensory Cyberdeck PCB - Package Contents

## ✅ Complete PCB Design Package

This package contains everything you need to manufacture and assemble your own Sensory Cyberdeck - a beautiful, tactile communication device with "The Board is the Product" design philosophy.
...
### Project Files
- **sensory_cyberdeck.kicad_pro** - KiCad project file (compatible with KiCad 7+)
...
│   ├── sensory_cyberdeck-F_Cu.gbr
│   ├── sensory_cyberdeck-B_Cu.gbr
│   ├── sensory_cyberdeck-F_Mask.gbr
│   ├── sensory_cyberdeck-B_Mask.gbr
│   ├── sensory_cyberdeck-F_SilkS.gbr
│   ├── sensory_cyberdeck-B_SilkS.gbr
│   ├── sensory_cyberdeck-Edge_Cuts.gbr
│   └── sensory_cyberdeck.drl
├── fabrication/
...
└── sensory_cyberdeck.kicad_pro ← KiCad project
```
